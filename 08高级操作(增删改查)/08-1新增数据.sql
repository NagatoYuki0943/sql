...
insert into 表名 [(字段列表)] values(),()...;
    ...
    insert into int2 values(null,14),(null,54),(null,85);
...
2 主键冲突
    ...
    又不确定数据表中是不是已经存在对应的主键
        ...
        //插不进去,主键重复
        insert into students3 values  ('stu0004','李四');
    ...
    解决方式:
        ...
        insert into 表名 [(字段列表)] values(值列表) on duplicate key update 字段 = 新值;
            ...
            insert into students3 values ('stu0004','李四') on duplicate key update stu_name="李四";
        ...
        (2) 主键冲突替换
            ...
            replace into students3 values('stu0004','哈哈哈哈');
            //成功替换
            | stu0004 | 哈哈哈哈 |
...
3 蠕虫复值
    ...
    基本语法:
        ...
        insert into simple values('a'),('b'),('c'),('d');
