...
double  双精度 8个字节存储数据
        ...
        有符号(SIGNED)范围   (-1.7976931348623157E+308,1.7976931348623157E+308)
        无符号(UNSIGNED)范围 0 和 2.2250738585072014E-308,1.7976931348623157E+308)

        基本语法
        double(M,D) : 表示一共存储M个有效数字,其中小数部分占D位
        double(10,3) : 整数部分7位,小数3位
